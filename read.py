...
excel_file_path = r"C:\Users\parth\Downloads\Book4.xlsx"

# Open the spreadsheet
workbook = openpyxl.load_workbook(r"C:\Users\parth\Downloads\Book4.xlsx")
...
driver.find_element(By.XPATH, '//*[text()="AI21Labs Jurassic-v2 Ultra"]').click()
